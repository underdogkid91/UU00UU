    ...
    addObjects: function () {
      ...
      this.addObject('base', new Dimensions.ExtrudeObject({
        geometry: [victory_hand_shape, {
          amount: 10,
          bevelEnabled: false,
          UVGenerator: Dimensions.Helpers.ExtrudeGeometryUVGenerator(1, 128/112, 0, 0)
        }],
        materials: {
          main: HandsMaterialsKit.side,
          front: HandsMaterialsKit.victory_front,
          back: HandsMaterialsKit.victory_back
        },
        rotation_y: Math.PI,
        rotation_z: Math.PI,
        position_y: 40,
